...
--------------------------
✅ Added skill → emoji mapping:
   • Bot now shows icons that match skills (⚔️ Attack, 🛡️ Defence, 🏠 Construction, etc.)
✅ Messages are cleaner:
   • Level-up notifications look like in-game announcements with the correct emoji.
✅ Quests/other activities use 📜.
"""
